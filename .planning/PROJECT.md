...
- [x] Adaptive residual texture resolution reduction based on measured reconstruction error, with manual override — Validated in Phase 4 (adaptive residual resolution) and 04.1 (D-13 residual auto-drop as the primary one-texture path: one RGBA8 surface PNG + vertex-colored mesh, honest-gate switch-back)
...
---
*Last updated: 2026-09-16 after Phase 04.1 completion*
