...
- [ ] 04.3-02-PLAN.md — CoverageTarget persistence (NamerProcessorSettings, D-05) + plumbing through NamerProjectionContext/CreateProjectionContext to GenerateResidual + reflection/prefs-sandbox test couplings
